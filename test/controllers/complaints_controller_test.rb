...
class ComplaintsControllerTest < ActionController::TestCase
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post :create, complaint: { complaint_type_id: @complaint.complaint_type_id, date_since: @complaint.date_since, location: @complaint.location, remarks: @complaint.remarks, user_id: @complaint.user_id }
    end
  ...
  test "should update complaint" do
    patch :update, id: @complaint, complaint: { complaint_type_id: @complaint.complaint_type_id, date_since: @complaint.date_since, location: @complaint.location, remarks: @complaint.remarks, user_id: @complaint.user_id }
    assert_redirected_to complaint_path(assigns(:complaint))
  end
